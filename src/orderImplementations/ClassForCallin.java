...
/**
 * public class which has all the methods.
 * 
 * @author Vijay Dehraj.
 *
 */
public class ClassForCallin {
	/**
	 * static method which has no parameter. Method consists of switch
	...
	public static void classforcall() {
		...
		while (restart.equalsIgnoreCase("Y")) {
			...
			try {
				// Taking input from the main category
				choice = in.nextInt();
				switch (choice) {
...
//			break; main case 1 break; not apply because of recalling the program.
// while loop closed.
// in.close();
